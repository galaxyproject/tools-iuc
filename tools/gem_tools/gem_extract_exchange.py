...
def get_exchange_reactions_info(model):
    ...
    for reaction in exchange_reactions:
        exchange_reactions_info.append([reaction.id, reaction.name, reaction.reaction, reaction.lower_bound, reaction.upper_bound])
...
def __main__():
    ...
    parser = argparse.ArgumentParser(
        prog = "GEM ",
        description = "This program retrieves the exchange fluxes of a GEM model to be used in Galaxy.",
