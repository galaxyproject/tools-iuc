...
SwitchList <- analyzeCPC2(
  ...
  SwitchList <- analyzeSignalP(
    SwitchList,
    pathToSignalPresultFile = c(
      "/home/laptop/stringtie_test/isoformSwitch_outputs/signalp_files/first_group/output_protein_type.txt",
  ...
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/gene.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
  switchPlot(
    ...
    SwitchList,
    gene = "PRMT5",
    #mostSwitchingGene$gene_id,
    #isoform_id = NULL,
    condition1 = "cancer",
    #mostSwitchingGene$condition_1,
    condition2 = "health",
    #mostSwitchingGene$condition_2,
    ### Advanced arguments
    IFcutoff = 0.05,
    dIFcutoff = 0.1,
    alphas = c(0.05, 0.001),
  ...
  switchPlotTopSwitches(
    ...
    sortByQvals = TRUE,
    filterForConsequences = FALSE,
    pathToOutput = "/home/laptop/stringtie_test/isoformSwitch_outputs/outputs",
    #getwd(),
  ...
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/consequencesEnrichment.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
  ...
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/splicingEnrichment.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
  ...
  ### Volcano like plot:
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/volcanoPlot.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
  ggplot(data = SwitchList$isoformFeatures, aes(
    x = dIF, y = -log10(isoform_switch_q_value)
  )) +
    geom_point(aes(
      color = abs(dIF) > 0.1 &
  ...
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/switchGene.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
  ggplot(data = SwitchList$isoformFeatures, aes(x = gene_log2_fold_change, y =
                                                  dIF)) +
    geom_point(aes(
      color = abs(dIF) > 0.1 &
        isoform_switch_q_value < 0.05
  ...
  pdf(
    file = '/home/laptop/stringtie_test/isoformSwitch_outputs/outputs/splicingGenomewide.pdf',
    onefile = FALSE,
    height = 6,
    width = 9
  )
