...
def main():
    ...
    parser.add_argument('--config_path', required=True, type=str, help="Path to save the generated YAML configuration.")
    parser.add_argument('--workflow', required=True, type=str, choices=['semantic', 'instance', 'detection', 'denoising', 'sr', 'cls', 'sr2', 'i2i'],)
    parser.add_argument('--dims', required=True, type=str, help="Number of dimensions for the problem", choices=['2d_stack', '2d', '3d'])
    ...
    parser.add_argument('--obj_size', required=True, type=str, help="Size of the objects in the images", choices=['0-25', '25-100', '100-200', '200-500', '500+'])
    ...
    # Save the YAML to config_path
    with open(args.config_path, 'w') as f:
        yaml.dump(config, f, default_flow_style=False)

    print(f"YAML configuration written to {args.config_path}")
