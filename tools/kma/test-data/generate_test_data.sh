...
head -n 10 b0842.fasta > ecoli_b0842_1to5.fasta

kma index -i ecoli_b0842_1to5.fasta -o ecoli_b0842_1to5

wget ftp://ftp.sra.ebi.ac.uk/vol1/fastq/ERR884/ERR884056/ERR884056_1.fastq.gz

bwa index ecoli_b0842_1to5.fasta

bwa mem ecoli_b0842_1to5.fasta ERR884056_1.fastq.gz -o ERR884056_1_ecoli_b0842_1to5.sam
