...
class HTMLRenderer:
    ...
    def render(self, page_header, left_nav_static):
        ...
        nav_container = '<div id="leftnav" class="col s2 grey lighten-3">'
        nav_closing = '</div>'
    ...
    def generate_nav_segments(self):
        snippet_lines = []
        self.segment_list.sort(key=lambda x: x.id)

        for seg in self.segment_list:
            snippet_lines.append(f'<a href="#segment{seg.id}">')
            snippet_lines.append('<div class="row subnavitem">')
            snippet_lines.append(f'<div class="col s12">Segment {seg.id} QC</div>')
            snippet_lines.append('</div>')
            snippet_lines.append('</a>')
    ...
    def gen_segment_qc(self, seg):
        snippet_lines = []
        snippet_lines.append(f'<div id="segment{seg.id}" class="row">')
        snippet_lines.append('<div class="spacer"></div>')
        snippet_lines.append(f'<h4>Segment {seg.id} QC</h4>')
        snippet_lines.append('<div class="divider"></div>')
        snippet_lines.append('<div class="spacer"></div>')
        snippet_lines.append('<div class="row segvisrow">')
        snippet_lines.append('<div class="col s12">')
        snippet_lines.append('<h5>Protein Info</h5>')

        imgdata = self.gen_text_image_data(seg.imgpaths["protein_FDR"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')

        imgdata = self.gen_text_image_data(seg.imgpaths["protein_score_cutoff"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')
        ...
        snippet_lines.append('<div class="row segvisrow">')
        snippet_lines.append('<div class="col s12">')
        snippet_lines.append('<h5>Peptide Info</h5>')
        imgdata = self.gen_text_image_data(seg.imgpaths["peptide_FDR"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')

        imgdata = self.gen_text_image_data(seg.imgpaths["target_decoy_histogram"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')

        imgdata = self.gen_text_image_data(seg.imgpaths["target_decoy_matched_scores"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')

        snippet_lines.append('</div>')
        snippet_lines.append('</div>')
        snippet_lines.append('<div class="row segvisrowtall">')
        snippet_lines.append('<div class="col s12">')
        imgdata = self.gen_text_image_data(seg.imgpaths["unique_peptide_ranks"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')
        ...
        snippet_lines.append('<div class="row segvisrowtall">')
        snippet_lines.append('<div class="col s12">')
        imgdata = self.gen_text_image_data(seg.imgpaths["unique_peptide_ranks_2"])
        snippet_lines.append(f'<img src="data:image/png;base64,{imgdata}">')
    ...
    def gen_segment_spectra(self, maxwidth="100%"):
        ...
        for seg in self.segment_list:
            snippet_lines.append(f'<p>Segment {seg.id}</p>')
            imgdata = self.gen_text_image_data(seg.imgpaths["spectrum_PMF"])
    ...
    def gen_proteins_of_interest(self):
        ...
        snippet_lines.append("<div id='proteins' class='row'>")
        snippet_lines.append("<div class='spacer'></div>")
    ...
    def gen_image_section(self, ident, title, imagepath, stype=1, maxwidth="100%"):
        ...
        if os.path.exists(imagepath):
            snippet_lines.append(f'<div id="{ident}" class="row">')
            snippet_lines.append('<div class="spacer"></div>')
            snippet_lines.append(f'<h4>{title}</h4>')
            snippet_lines.append('<div class="divider"></div>')
            snippet_lines.append('<div class="spacer"></div>')
...
<div class="col s12 center"><h4>HiT-MaP</h4><p>v1.0</p></div>
</div>

<a href="#segmentation"><div class="row subnavitem" id="item3" onclick="change_tab(this.id);">
<div class="col s12">Sample segmentation</div>
</div></a>

<a href="#pca"><div class="row subnavitem" id="item4" onclick="change_tab(this.id);">
<div class="col s12">Principle Component Analysis</div>
</div></a>

<a href="#proteins"><div class="row subnavitem" id="item5" onclick="change_tab(this.id);">
<div class="col s12">Proteins of Interest</div>
</div></a>

<a href="#segment-mean-spectra"><div class="row subnavitem" id="item6" onclick="change_tab(this.id);">
<div class="col s12">Segment Mean Spectra</div>
</div></a>

<a href="#segment-spectra-match"><div class="row subnavitem" id="item7" onclick="change_tab(this.id);">
<div class="col s12">Segment spectra match</div>
</div></a>

<a href="#outliers"><div class="row subnavitem" id="item8" onclick="change_tab(this.id);">
<div class="col s12">Peptide Score Outliers</div>
</div> </a>
"""
