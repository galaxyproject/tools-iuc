      seqfile = /tmp/tmpm2BU9M/files/000/dataset_37.dat * sequence data file name 
      outfile = run_codeml * main result file name 
     treefile = /tmp/tmpm2BU9M/files/000/dataset_38.dat * tree structure file name
...
*       ndata = 10 
   ...
   aaRatefile = wag.dat * only used for aa seqs with model=empirical(_F) 
    ...
    fix_omega = 1.0  * 1: omega or omega_1 fixed, 0: estimate  
