...
mydata = read.table("out/number_of_new_genes.Rtab")
png(filename = "out/number_new_genes.png", width = 6, height = 4, units = "in", res = 300)
...
mydata = read.table("out/number_of_conserved_genes.Rtab")
png(filename = "out/number_of_conserved_genes.png", width = 6, height = 4, units = "in", res = 300)
boxplot(mydata, data=mydata, main="Number of conserved genes",
          xlab="No. of genomes", ylab="No. of genes",varwidth=TRUE, ylim=c(0,max(mydata)), outline=FALSE)
dev.off()
    
mydata = read.table("out/number_of_genes_in_pan_genome.Rtab")
png(filename = "out/number_of_genes_in_pan.png", width = 6, height = 4, units = "in", res = 300)
boxplot(mydata, data=mydata, main="No. of genes in the pan-genome",
          xlab="No. of genomes", ylab="No. of genes",varwidth=TRUE, ylim=c(0,max(mydata)), outline=FALSE)
dev.off()

mydata = read.table("out/number_of_unique_genes.Rtab")
png(filename = "out/number_of_unique_genes.png", width = 6, height = 4, units = "in", res = 300)
boxplot(mydata, data=mydata, main="Number of unique genes",
         xlab="No. of genomes", ylab="No. of genes",varwidth=TRUE, ylim=c(0,max(mydata)), outline=FALSE)
dev.off()

mydata = read.table("out/blast_identity_frequency.Rtab")
png(filename = "out/blast_identify_frequency.png", width = 6, height = 4, units = "in", res = 300)
...
conserved = colMeans(read.table("out/number_of_conserved_genes.Rtab"))
total = colMeans(read.table("out/number_of_genes_in_pan_genome.Rtab"))
...
ggsave(filename="out/conserved_vs_total_genes.png", scale=1)

######################

unique_genes = colMeans(read.table("out/number_of_unique_genes.Rtab"))
new_genes = colMeans(read.table("out/number_of_new_genes.Rtab"))
...
ggsave(filename="out/unique_vs_new_genes.png", scale=1)
