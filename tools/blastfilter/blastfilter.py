    ...
    with open(outfile, "w") as handle:
        for line in blast_species_A:
            ...
            if pident_method == "static":
                if outfmt == "raw" or outfmt == "rbhplus":
                    if (
                        pident >= option_pident
                        and length >= option_length
                        and covs >= covs_option
                        and covq >= covq_option
                    ):
                        handle.write(line)
                if outfmt == "std":
            ...
            if pident_method == "rost1999":
                if outfmt == "raw" or outfmt == "rbhplus":
                    if (
                        pident >= get_pident_by_length(length)
                        and covs >= covs_option
                        and covq >= covq_option
                    ):
                        handle.write(line)
