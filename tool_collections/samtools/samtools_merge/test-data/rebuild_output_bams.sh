samtools merge -s 1 -f 1.merge.expected.bam test_input_1_a.sam test_input_1_b.sam test_input_1_c.sam
...
samtools merge -s 1 -f -c -p 4.merge.expected.bam test_input_1_b.bam
