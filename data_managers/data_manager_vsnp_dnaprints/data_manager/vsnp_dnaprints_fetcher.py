...
def download(dbkey, name, url, out_file):
    ...
    data_manager_entry['description'] = "DNAprints file for %s" % name
    data_manager_json["data_tables"]["vsnp_dnaprints"] = data_manager_entry
...
parser.add_argument('--url', dest='url', help='URL to download DNAprints file')
