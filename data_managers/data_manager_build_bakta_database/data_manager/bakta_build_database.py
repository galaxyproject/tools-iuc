...
class GetBaktaDatabaseInfo:
    ...
    def __init__(self,
        ...
        self.DB_TEST_URL = 'https://zenodo.org/record/8017774/files/db-versions.json'
        ...
        if self.db_version == "latest":
            ...
            if filtered_version is None:
                ...
                self.db_url = f"https://zenodo.org/record/" \
                                f"{filtered_version['record']}/files/{self.tar_name}"
...
class InstallBaktaDatabase(GetBaktaDatabaseInfo):
    ...
    def download(self):
        ...
        try:
            ...
            print(f'ERROR: Could not download file from Zenodo!'
                  f' url={self.db_url}, path={self.tar_name}')
    ...
    def untar(self):
        ...
        try:
            ...
            sys.exit(f'ERROR: Could not extract {self.tar_name} '
                     f'to {self.db_name}')
...
def main():
    ...
    bakta_upload = InstallBaktaDatabase(test_mode=all_args.test, db_version=all_args.database_version)
...
self = InstallBaktaDatabase(db_version="5.0_light",test_mode="True")
